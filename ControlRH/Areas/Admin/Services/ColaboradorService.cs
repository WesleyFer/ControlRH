...
public class ColaboradorService : IColaboradorService
{
    ...
    public async Task<IEnumerable<Colaborador>> GetAllAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Colaborador?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
        return await _queryContext.QueryColaboradores
    ...
    public async Task<DynamicTableViewModel> ObterTabelaIndexAsync(string? search, int page = 1, int pageSize = 5, string? sort = null, string? dir = null, CancellationToken cancellationToken = default)
    {
        ...
        {
            var parameter = Expression.Parameter(typeof(Colaborador), "c");
            ...
            var genericMethod = method.MakeGenericMethod(typeof(Colaborador), property.Type);

            query = (IQueryable<Colaborador>)genericMethod.Invoke(null, new object[] { query, lambda });
        }
    ...
    public async Task InserirColaboradorComUsuarioAsync(ColaboradorViewModel viewModel, CancellationToken cancellationToken = default)
    {
        ...
        var repositorio = _uow.Repository<Colaborador>();
