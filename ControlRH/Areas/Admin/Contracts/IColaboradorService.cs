...
{
    Task<IEnumerable<Colaborador>> GetAllAsync(CancellationToken cancellationToken = default);
    ...
    Task<Colaborador?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
